...
/**
 * Composable function to display the Acceleration Display Screen.
 *
 * This screen shows the current acceleration data and provides options to start/stop recording.
 *
